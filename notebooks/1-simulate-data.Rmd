...
Simulation study 1 -- parametric model for multinomial case
...
Simulation study 2 -- non-parametric model for multinomial case 
...
```{r}
set.seed(123)
rep_x <- as.integer(2000*c(50, 100, 150, 200))
...
sel <- rbinom(n = nrow(df), size = 1, prob = rho)
table(sel)
```
